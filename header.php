    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
        <div class="navbar-header">
           <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false">
            ...
            <img src="images/logooffice.png" class="navbar-brand" height="80" width="80">
...
?></a>
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav ">
              ...
              <li><a  href="flow-circle-front.php"><i class="fas fa-retweet"></i> หนังสือเวียนจังหวัด</a></li>
              <li><a  href="flow-command-front.php"><i class="fas fa-gavel"></i> หนังสือคำสั่ง</a></li>
              <li><a href="flow-buy-front.php"><i class="fas fa-bullhorn"></i> ประกาศ</a></li>
              <li><a href="underconstruction.php"><i class="fas fa-shopping-cart"></i> จัดซื้อ-จัดจ้าง</a></li>
              <li class="dropdown">
                <a class="dropdown-toggle" data-toggle="dropdown" href="#"><i class="fas fa-users"></i> ลงทะเบียน
          ...
          <ul class="nav navbar-nav navbar-right">
            <li><a  data-toggle="modal" data-target="#myModal"><i class="fas fa-key"></i> เข้าสู่ระบบ </a></li>
            <li><a  href="#" data-toggle="modal" data-target="#modelRule">ข้อตกลงการใช้งาน</a></li>
          </ul>
    </nav>
        <!-- Modal -->
