             ...
             <div class="panel panel-primary" style="margin: 20">
                 <div class="panel-heading"><i class="fa fa-envelope-open-o fa-2x" aria-hidden="true"></i>  <strong>แก้ไข/เพิ่มเติม</strong></div>
                   <i class="badge"> ข้อมูลทั่วไป </i>                   
                    <div class="well">
                     <form name="form" method="post" action="flow-unit.php" enctype="multipart/form-data">
                        <table width="800">
                            <tr>
                                <td> 
                                    <div class="form-group form-inline">
                                        <span for="typeDoc">ประเภทหนังสือ :</span>
                                        <input class="form-control" name="typeDoc" type="radio" value="0" <?php if($typeDoc==0){ echo "checked";}?>> ปกติ
                                        <input class="form-control" name="typeDoc" type="radio" value="1" <?php if($typeDoc==1){ echo "checked";}?>> เวียน
                                    </div>
                                </td>
                                <td>
                        ...
                        <div class="well">  
                            <table>
                                ...
                                <tr>
                                    <td>
                                        <div class="form-group form-inline">
                                            <span for="fileupload">แนบไฟล์</span>
                                            <input type="file" name="fileupload"  class="alert-success">
                                             <a href="<?php print $fileUpload ?>" target="_blank"><i class="fa fa-file-text"></i>สำเนาหนังสือ</a>
                                        </div> 
                                    </td>
                                </tr>
                            </table>
