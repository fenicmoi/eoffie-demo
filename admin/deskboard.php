                    ...
                    <div class="bg-danger">
                        <center>
                         <a href="paper.php" data-toggle="tooltip1" title="เอกสารจากส่วนราชการต่าง ๆ!">
                            ...
                            <h5>เอกสารใหม่ <span class="badge"><?php print $row['pcount'];?></span></h5>
                         </a>
                        </center>
                        </div>
                    </div>
                    ...
                    <div class="bg-danger">
                        <center>
                            <a href="FlowResiveProvince.php">
                                ...
                                <h5>หนังสือเข้าใหม่ <span class="badge"><?php print $num;?></span></h5>
                            </a>
                        </center>   
                    </div>
                </div>
                                                ...
                                                <div class="panel-group">
                                                    ...
                                                    <div class="panel-heading">
                                                        <h4 class="panel-title">
                                                            <a data-toggle="collapse" href="#menu1"><center><i class="fa fa-briefcase fa-2x text-center"></i><br> ระบบงานสารบรรณ</center></a>
                                                        </h4>
                                                    </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="bg-success">
                                                <div class="panel-group">
                                                    ...
                                                    <div class="panel-heading">
                                                        <h4 class="panel-title">
                                                            <a data-toggle="collapse" href="#menu2"><center><i class="fas fa-credit-card fa-2x"></i><br> ทะเบียนคุมเอกสารจัดซื้อจัดจ้าง</center></a>
                                                        </h4>
                                                    </div>
