        ...
        <div class="col-md-10">
            <div class="panel panel-primary" style="margin: 10">
                <div class="panel-heading"><i class="fas fa-calendar fa-2x"></i>   <strong>ปฏิทินการใช้ห้องประชุม</strong>
                    ...
                    <a class="btn btn-warning pull-right" href="meet_room_user.php">
                        <i class="fas fa-info"></i> ดูห้องประชุม
                    </a>
                     <a class="btn btn-warning pull-right" href="meet_history.php">
                        <i class="fas fa-history"></i> แก้ไขการจอง
                    </a>
                    <a class="btn btn-warning pull-right" href="doc/form.pdf" target="_blank">
                        <i class="fab fa-wpforms"></i> แบบขออนุมัติ
                    </a>
                    <a class="btn btn-warning pull-right" href="doc/info.pdf" target="_blank">
...
if(isset($_POST['save_reserv'])){
    ...
    if($numpeople > $row['roomcount']){         //เช็คจำนวนผู้เข้าประชุม
        ...
        echo"<script>
            ...
            list($hour, $minute) = preg_split('[:]',$starttime);
            $starttime = "$hour:$minute";

            list($hour, $minute) = preg_split('[:]',$endtime);
            $endtime = "$hour:$minute";
